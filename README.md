...
[CI](https://github.com/jae-yon/fam-archive/actions/workflows/ci.yml)
...
- WYSIWYG(TipTap) 기반 리치 텍스트 게시글 작성 · 수정 · 삭제
- 카테고리 관리 및 필터
- 제목 / 본문 텍스트 검색
...
프로젝트 루트에 `.env` 파일을 생성합니다. **실제 패스워드, 시크릿키 등은 커밋하지 않도록 주의**
